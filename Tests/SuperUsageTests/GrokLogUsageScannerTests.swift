...
final class GrokLogUsageScannerTests: XCTestCase {
    private let since = SuperUsageISO8601.date(from: "2026-06-01T00:00:00.000Z")!
    ...
    func testScanReadsGrokHomeOverride() async {
        ...
        let usage = await scanner.scan(daysBack: 30, now: SuperUsageISO8601.date(from: "2026-06-18T00:00:00.000Z")!, pricing: TestPricing.bundled)
