...
enum TestPricing {
    static let bundled: ModelPricing = {
        func resource(_ name: String) -> Data {
            guard let url = Bundle.superUsageResources.url(forResource: name, withExtension: "json"),
...
enum ClaudeLogFixture {
    ...
    static func makeHome(files: [String: String] = [:]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superusage-claude-\(UUID().uuidString)", isDirectory: true)
    ...
    static func makeUserHome(
        ...
        let home = FileManager.default.temporaryDirectory
            .appendingPathComponent("superusage-claude-home-\(UUID().uuidString)", isDirectory: true)
...
enum CodexLogFixture {
    ...
    static func makeHome(files: [String: String] = [:]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superusage-codex-\(UUID().uuidString)", isDirectory: true)
    ...
    static func scanner(home: URL?) -> CodexLogUsageScanner {
        CodexLogUsageScanner(
            ...
            homeDirectory: { FileManager.default.temporaryDirectory.appendingPathComponent("superusage-no-codex-home") },
