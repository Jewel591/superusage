...
final class CodexLogUsageScannerTests: XCTestCase {
    ...
    private var childCreationEpoch: Int {
        Int(SuperUsageISO8601.date(from: "2026-05-12T08:03:00.000Z")!.timeIntervalSince1970)
    }
    ...
    private func makeEvent(
        ...
        CodexLogUsageScanner.Event(
            timestamp: SuperUsageISO8601.date(from: timestamp)!,
    ...
    func testAggregateFiltersEventsBeforeSince() {
        let scan = CodexLogUsageScanner.aggregate(
            ...
            since: SuperUsageISO8601.date(from: "2026-05-01T00:00:00.000Z")!,
            pricing: fixedRates()
        )
    ...
    func testScanKeepsDistinctFilesThroughSymlinkedHome() async throws {
        ...
        let base = FileManager.default.temporaryDirectory
            .appendingPathComponent("superusage-codex-symlink-\(UUID().uuidString)", isDirectory: true)
    ...
    func testParityAgainstRealLocalLogs() async throws {
        try XCTSkipUnless(ProcessInfo.processInfo.environment["SUPERUSAGE_CODEX_PARITY"] == "1")
