...
final class AppLogTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("superUsageTests.AppLog.\(UUID().uuidString)", isDirectory: true)
        sink = LogFile(directory: tempDir, fileName: "superUsage.log")
        sink.open()
    ...
    private func fileContents() throws -> String {
        try String(contentsOf: tempDir.appendingPathComponent("superUsage.log"), encoding: .utf8)
    }
    ...
    func testSlowProviderRefreshWritesWarningAtDefaultLogLevel() async throws {
        ...
        let defaultsName = "superUsageTests.AppLog.slow.\(UUID().uuidString)"
