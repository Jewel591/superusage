...
final class LocalLimitsAPITests: XCTestCase {
    private let fetchedAt = SuperUsageISO8601.date(from: "2026-07-13T01:39:30.000Z")!
    private let generatedAt = SuperUsageISO8601.date(from: "2026-07-13T01:40:00.000Z")!
    ...
    func testLimitsEnvelopeCarriesRawScalarsAndFreshnessWithoutUIPresentation() throws {
        ...
        let snapshot = ProviderSnapshot(
            ...
            lines: [
                .progress(
                    ...
                    resetsAt: SuperUsageISO8601.date(from: "2026-07-13T06:00:00.000Z"),
        ...
        XCTAssertEqual(root["schema"] as? String, "superusage.limits.v1")
