...
final class CursorOptionalEndpointTests: XCTestCase {
    ...
    private func captureLogs(
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("superUsageTests.CursorOptional.\(UUID().uuidString)", isDirectory: true)
        let sink = LogFile(directory: directory, fileName: "superUsage.log")
        sink.open()
        ...
        let logs = try String(contentsOf: directory.appendingPathComponent("superUsage.log"), encoding: .utf8)
