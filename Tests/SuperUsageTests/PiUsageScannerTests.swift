...
/// The pi log fold-in: parse pi's assistant usage lines, attribute them to the mapped SuperUsage card,
...
final class PiUsageScannerTests: XCTestCase {
    private func d(_ iso: String) -> Date { SuperUsageISO8601.date(from: iso)! }
