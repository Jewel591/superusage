...
final class ICloudUsageSyncStoreTests: XCTestCase {
    ...
    func testDeviceIdentitySurvivesPreferencesResetThroughKeychainStore() {
        ...
        firstDefaults.set(expectedID, forKey: "superusage.icloudSync.deviceID.v1")
        ...
        XCTAssertEqual(resetDefaults.string(forKey: "superusage.icloudSync.deviceID.v1"), expectedID)
    }
    ...
    func testKeychainIdentityIsScopedToDevelopmentAndProductionBundles() throws {
        ...
        let development = KeychainICloudDeviceIDStore(
            keychain: keychain,
            bundleIdentifier: "com.weisenjoytech.superusage.dev"
        )
        let production = KeychainICloudDeviceIDStore(
            keychain: keychain,
            bundleIdentifier: "com.weisenjoytech.superusage"
        )
    ...
    private func makeDefaults(_ name: String) -> UserDefaults {
        let suite = "superUsageTests.ICloudSync.\(name).\(UUID().uuidString)"
