...
/// - **Legacy disabled-list** (`superusage.disabledProviders.v1`): only the *disabled* IDs are persisted.
...
/// - **Enabled-list** (`superusage.enabledProviders.v1`): only the *enabled* IDs are persisted. Fresh
...
///
/// A third set — **known provider IDs** (`superusage.knownProviders.v1`) — records every provider this
...
final class ProviderEnablementStore {
    private static let disabledStorageKey = "superusage.disabledProviders.v1"
    private static let enabledStorageKey = "superusage.enabledProviders.v1"
    private static let knownStorageKey = "superusage.knownProviders.v1"
