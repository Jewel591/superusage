...
final class NotificationSettingsStore {
    ...
    private static let underTenKey = "superusage.notifications.underTenPercent"
    private static let healthyToCloseKey = "superusage.notifications.healthyToClose"
    private static let closeToRunningOutKey = "superusage.notifications.closeToRunningOut"
