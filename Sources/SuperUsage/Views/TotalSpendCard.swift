...
struct TotalSpendCard: View {
    ...
    @AppStorage("superusage.totalSpend.period") private var periodRawValue = TotalSpendPeriod.today.rawValue
    /// The selected metric (Cost / Cost/MTok / Tokens) survives the same way.
    @AppStorage("superusage.totalSpend.metric") private var metricRawValue = TotalSpendMetric.cost.rawValue
