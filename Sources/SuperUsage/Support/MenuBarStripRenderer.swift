...
enum MenuBarStripRenderer {
    ...
    static let privacyImage: NSImage? = {
        ...
        image.isTemplate = true
        image.accessibilityDescription = "superUsage, usage hidden while the screen is shared"
        return image
    }()
...
/// The product wordmark drawn in place of the strip while screen-share privacy is concealing usage.
...
/// Draws up to four horizontal usage bars into a compact square — a 1:1 port of the original SuperUsage
...
/// remainder rules are unit-testable. A 1:1 port of the original SuperUsage tray math.
