...
enum SettingsSchema {
    ...
    static let migrations: [SettingsMigration] = [
        ...
        SettingsMigration(version: 2) { defaults in
            if defaults.stringArray(forKey: "superusage.enabledProviders.v1") == nil {
                let disabled = Set(defaults.stringArray(forKey: "superusage.disabledProviders.v1") ?? [])
                let enabled = v2ProviderIDs.filter { !disabled.contains($0) }
                defaults.set(enabled, forKey: "superusage.enabledProviders.v1")
                defaults.removeObject(forKey: "superusage.disabledProviders.v1")
            }
            if defaults.stringArray(forKey: "superusage.knownProviders.v1") == nil {
                defaults.set(v2ProviderIDs, forKey: "superusage.knownProviders.v1")
            }
        }
    ]
}
...
enum SettingsMigrator {
    ...
    static let schemaVersionKey = "superusage.settings.schemaVersion"
