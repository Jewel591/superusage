...
final class UpdaterController {
    ...
    func checkForUpdates() {
        ...
        // Sparkle 2.9.4 also activates dockless apps with `ignoringOtherApps`, but promote SuperUsage
...
final class UpdaterUserDriverDelegate: NSObject, SPUStandardUserDriverDelegate {
    ...
    /// Restores SuperUsage to its normal dockless activation policy after Sparkle finishes the session.
