...
If you find a security vulnerability in superUsage, please report it responsibly. Do not open a public issue.

### Preferred: GitHub Security Advisories

1. Go to the [Security Advisories page](https://github.com/Jewel591/superusage/security/advisories/new)
...
- The superUsage desktop application
