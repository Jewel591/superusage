...
- **Spend tiles show "No data"** — SuperUsage found no Codex session logs in the last 30 days. If your Codex home lives somewhere custom, set `CODEX_HOME` so both the Codex CLI and SuperUsage look in the same place.
